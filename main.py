'''
In this file we will load the data and we will then implement ML Pipeline techniques which are required
'''
import numpy as np
import pandas as pd
...
if __name__ == '__main__':
    try:
        obj = CUSTOMER_CHURN_DATA('C:\\Users\\meenu\\Downloads\\AI-Powered-Telecom-Customer-Retention-Prediction-System-main\\project\\Sample_data.csv')
        obj.missing_values()
        obj.var_trns_out()
        obj.feature_s()
        obj.cat_num()
